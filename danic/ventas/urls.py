...
from .views import eliminar_producto, estufas, freidoras, home, celulares, lavadoras, microondas, neveras, televisores, ventiladores, contacto, agregar_producto, listar_productos, modificar_producto, registro
